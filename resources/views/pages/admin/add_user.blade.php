...
@section('content')
    <section class="section-data-user">
        <div class="wrapper-btn-create mb-5">
            <button type="button" class="btn btn-primary btn-input" data-bs-toggle="modal" data-bs-target="#add-user">Tambah User</button>
        ...
        <div class="wrapper-heading-info mb-4">
                ...
                <div class="tab-pane fade show active" id="pasien" role="tabpanel" aria-labelledby="pasien-tab">
                    <div class="row-list-user">
                        <div class="col-md-4 col-sm-12 p-3">
                            <form action="{{ route('list_user') }}">
                                <input type="search" class="form-control input-search" name="search_by" placeholder="Cari data" autocomplete="off" spellcheck="false" value="{{ request('search_by') }}">
                            </form>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-warning btn-input" data-bs-toggle="modal" data-bs-target="#data-{{ $item->id }}">
