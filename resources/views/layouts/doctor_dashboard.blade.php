                ...
                <div class="container-navbar">
                    <div class="wrapper-navbar">
                        <div class="col text-center headline-navbar py-4">
                            ...
                            @endif
                            <div class="row">
                                <label class="text-muted">Dokter</label>
                                <p class="greetings-dashboard">Hi, {{ $data->name }}</p>
                            </div>
                        </div>
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item {{ $title == 'Dashboard Dokter' ? 'active' : '' }}">
                                <a class="nav-link py-0" href="{{ route('dashboard_doctor') }}">
                                    <i class='bx bx-home-alt-2 icon '></i>
                                    <div class="nav-name">Dashboard</div>
                                </a>
                            </li>
                            <li class="nav-item {{ $title == 'Pasien Masuk' ? 'active' : '' }}">
                                <a class="nav-link py-0" href="{{ route('patient_in') }}">
                                    <i class='bx bx-user icon'></i>
                                    <div class="nav-name">Antrian Masuk</div>
                                </a>
                            </li>
                            <li class="nav-item {{ $title == 'Riwayat Pemeriksaan Pasien' ? 'active' : '' }}">
                                <a class="nav-link py-0" href="{{ route('checkup_history') }}">
                                    <i class='bx bx-layer icon'></i>
                                    <div class="nav-name">Riwayat Periksa</div>
                                </a>
                            </li>
                            <li class="nav-item {{ $title == 'Jadwal Saya' ? 'active' : '' }}">
                                <a class="nav-link py-0" href="{{ route('schedule') }}">
                                    <i class='bx bx-calendar icon'></i>
                                    <div class="nav-name">Jadwal</div>
                                </a>
                            </li>
                        </ul>
                    </div>
